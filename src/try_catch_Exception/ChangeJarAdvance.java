...
public class ChangeJarAdvance {
	 ...
	 * @return 
	  ...
	  public ChangeJarAdvance(Scanner scanner) {
	  ...
	  public static void main(String[] args) {
	    ...
	    // Create the ChangeJarAdvanced instance
	    ChangeJarAdvance cja = new ChangeJarAdvance(scanner);
	...
	/**
	  ...
	  private static void showUsage() {
	    outputMessage("Usage: ");
	    outputMessage("\t" + ChangeJarAdvanced.class.getSimpleName() + " scan_option");
	    outputMessage("Where:");
