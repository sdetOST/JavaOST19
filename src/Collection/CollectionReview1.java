...
public class CollectionReview1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("First row Gender colomn : " + allRowMaps.get(0).get("Gender"));
		System.out.println("Second row Age colomn : " + allRowMaps.get(1).get("Age"));
		System.out.println("Third row Name colomn :  " + allRowMaps.get(2).get("Name"));
