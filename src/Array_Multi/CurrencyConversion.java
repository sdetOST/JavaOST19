...
another 2d array of strings, 
first place in each row holds the currency name 
...
public class CurrencyConversion {
	...
	public static double convertC(String[][] money, String[][] convertionRate) {
		...
		for (int i = 0; i < convertionRate.length; i++) {
			double x1 = Double.parseDouble(money[i][1]);
			double x2 = Double.parseDouble(convertionRate[i][1]);
			total$ += x1 * x2;
		}
		return total$;
	}
	
	public static double convertTo$(String[][] money) {
